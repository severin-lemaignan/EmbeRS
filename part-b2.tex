...
Correctly interpreting our social environment is tremendously complex for
...
In summary, the critical need for social robots to accurately interpret and
...
\begin{enumerate}[label=\textbf{O\arabic*}]
    ...
    \item \label{O2.2} To use social embeddings to model \textbf{social dynamics}
...
Education Need (SEN) school (O2.1.1), followed by a one-year deployment at
Bristol's Children's hospital (O2.1.2). These two additional experiments are both
...
architecture (O2.3.3), iteratively improving the socio-cognitive performances of
the robot.
...
datasets acquired during the field deployments (T1.1, O2.1.1, O2.1.2), as well as
lab-recorded dataset of social interactions. Similar to WP2, the capabilities
built in WP3 are integrated in the robot architecture in O2.3.3.
...
human-in-the-loop/public-in-the-loop machine learning (O2.3.2). O2.3.2, in
particular, is tighly connected to the experimental fieldwork, where the
learning-from-end-users take place.

\end{rewrite}

\subsubsection{Application to Social Robotics}
