...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{State-of-art: social representations and artificial social agents}
...
To effectively interpret this situation, an artificial social agent needs a \emph{joint}
...
To illustrate how some of these objectives relate to each other, let consider
