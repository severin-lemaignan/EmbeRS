...
Be it avatars in virtual worlds or social robots in our physical world,
artificial social agents need to reason about their social environment.  While,
as humans, we might have an intuitive understanding of our social environment,
for an artificial intelligence (AI) to automatically create such models to
reason and make decisions in real-time is fundamentally an open problem.
...
One example, taken from a paper I wrote~\cite{webb2021framing}: on the
picture on the left, the three people are
engaged in the same conversation but display different expressions and moods.
As humans, and even without additional context, we can infer much:
One person is leading the conversation, whilst the others are listening.
The expression on the person in the middle shows a amused frown, suggesting
that, while enjoying the interaction, they may interject soon, whilst the person
on the left seems to be passive, and maybe less engaged. Their gaze direction
suggests that there are others in the group not captured in the snapshot.
Overall the interaction presents as a positive one, as all three people seem
