...
\paragraph{\bf O2: real-time social context modeling} Critical to long-term sustain
engagement is the understanding by the robot of its social and spatial environment: this
...
avenues like \emph{social embeddings} to enable more effective machine learning.

\paragraph{\bf O3: embodied AI breakthrough}
...
and learnt from the end-users using human-in-the-loop attention-based machine learning.
...
additional layer of human oversight and a level of behavioural transparency.
Human-in-the-loop reinforcement learning -- as implemented in the SPARC approach
that I have developed with my students and already used in complex social
...
autonomous. As I previsouly argued in~\textcite{senft2019teaching}, this
approach leads to increased control and ownership of the system, and as a
result, increased trust from the end-users.

\paragraph{\bf O4: ambitious field research} Finally, the last major objective
...
robots in existing social \emph{ecosystems} that are sufficiently complex and open to
...
{\bf Together, these four objectives build a coherent and realistic
pathway towards addressing the overall aim of my research program:
...
(\textbf{H2}) Additionally, long-term acceptance requires the
genuine involvement of end-users at every step of the design process, so that
