...
Closely aligned with the EPSRC Delivery Plan priorities, \project creates a
...
\ul{Progressing this question requires real-world evidence}. Because
autonomous social robots lay at the very edge of science and engineering, the
required real-world, long-term deployments are however extremely rare. As a
consequence, we only have limited insights on the factors pertaining to the
utility and acceptability of social robots.
...
to the society}. By learning social behaviours directly \textbf{with and from}
the public and end-users, I propose not only to create a
\textbf{state-of-the-art autonomous social robot}, but also a robot
\textbf{co-designed from the ground-up to be acceptable, responsible and useful}
to the humans it will serve.
...
While I have done so (see Track-record section below), the fellowship will
undoubtely further assert myself as one of the leaders in Human-Robot
Interaction (HRI) -- and reaffirm the UK preemience in socially intelligent AI.
...
I will specifically test two hypotheses: first, I hypothesise that long-term
...
\begin{table}[h]
    ...
    \begin{tabular}{rp{0.6\linewidth}}
        ...
        trust, engagement, social presence & \small \cite{flook2019impact}\cite{lemaignan2015youre}\cite{fink2014which}\cite{irfan2018social} \\
