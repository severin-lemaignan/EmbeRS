...
\begin{itemize}
        ...
        \item novel spatio-temporal and social model of the robot's environment;
...
Closely aligned with the EPSRC Delivey Plan priorities, \project creates a
unique opportunity to establish myself as one of the key leader in
Intelligent Social Robotics, asserting as well the worldwide UK leadership
in AI and robotics.
...
in a range of sensitive domains like education, elderly care, healthcare.
Critically, we, as a society, need to develop in parallel the underpinning principles that will
ensure the future roles of social robots are collectively
defined, in a responsible and ethical manner -- in particular in the context of vulnerable
populations.

Progressing this question requires real-world evidence. Because autonomous
social robots lay at the very edge of science and engineering, the required
real-world, long-term deployments are however extremely rare. As a consequence,
we only have limited insights on the factors pertaining to the utility and
acceptability of social robots.

\project approaches this important and timely question in a \textbf{novel and
ambitious} manner: \project defines and implements \textbf{a vision of AI and
social robotics that places the human at the centre of these emerging
technologies, to foster novel social dynamics that are accepted and beneficial
to the society}. By learning social behaviours \textbf{with and from} the public
and end-users, I propose not only to create a \textbf{state-of-the-art
autonomous social robot}, but also a robot \textbf{co-designed from the
ground-up to be acceptable, responsible and useful} to the humans it will serve.
...
These questions are of prime societal importance, and indeed, \project closely
...
The \project project is \textbf{highly ambitious}: I will bring together two emerging AI
...
(eg. creating a body language with a choreagrapher and novel expressive sounds
...
think public engagement with technology design; finally, I will deploy this
co-designed autonomous robot in two, socially sensible, settings, for long
periods of time.

Scientific ambition, engineering ambition, methodological ambition: the \project
project sets a high bar for excellence, which leads to a fourth ambition:
establishing myself as one of the key leader in social robotics. Surprisingly
few groups worldwide have achieved full autonomy for a complex social robot.
While I have done so (see Track-record section below), the fellowship will undoubtely
further assert myself as one of the leaders in HRI -- and reaffirm the
UK preemience in socially intelligent AI.
...
This broad aim translates in three key research questions:
...
capability of artificial \emph{social situation assessment}, and enabling the
...
also contributes to RQ2, and is the focus of WP3.
...
environments~\footfullcite{senft2017supervised, senft2019teaching, winkle2020insitu} -- relies
...
in~\footfullcite{senft2019teaching}, this approach leads to increased control and
ownership of the system, and as a result, increased trust.

This addresses RQ2 and RQ3; however it also raise one additional question: how to
...
My experimental approach has two phases: first, I will co-design and co-construct
the robot social role and behaviours through large scale public
...
where I currently run pilots, helping 250+ children with psycho-social
impairments to develop their social skills; a second one-year experiment at the
Bristol's children hospital, where the robot will join one of the wards where
30+ children with long-term conditions stay for months, and engage with the
children into playful social activities: telling stories, triggering group
activities with other children, providing additional social presence. In both
these experiments, the robot behaviours will be co-designed with, and learnt
from the end-users themselves: nurses, teachers, parents, and where possible,
...
extending the state-of-the-art~\footfullcite{lemaignan2017artificial, baxter2016cognitive}.
...
developed~\footfullcite{lemaignan2018underworlds, sallami2019simulation} with recent
advances in data-driven semantic labelling (for instance, using 4D convolution
nets like MinkowskiNet~\footfullcite{choy20194d}), and a symbolic knowledge base (like
my own ontology-based one~\footfullcite{lemaignan2010oro}) in order to create a coherent
...
(eg~\footfullcite{gunes2017automatic,lemaignan2016realtime}) and data-driven based
(eg~\footfullcite{bartlett2019what}). This task goes beyond the state-of-the-art by
...
work~\footfullcite{lemaignan2018pinsoro}, as well as from the project experiments (T1.2,
T5.1, T5.2).
...
interactions~\footfullcite{tapus2019perceiving}, including
$f$-formations~\footfullcite{marshall2011using}, sociograms (as done
in~\footfullcite{garcia2016hybrid} for instance), and inter-personal
affordances~\footfullcite{pandey2013affordance}. This task builds on literature on 
social dynamics analysis (eg~\footfullcite{durantin2017social,jermann2009physical,
...
Happé~\footfullcite{frith1994autism}, that I introduce in~\footfullcite{lemaignan2015mutual}) to
...
(behaviours library, activity switching~\footfullcite{coninx2016towards}). This
...
robot motion generation~\footfullcite{marmpena2019generating,suguitan2020moveae} (with
...
behaviours~\footfullcite{senft2019teaching, winkle2020insitu} that fully involve the
end-users~\footfullcite{winkle2018social}. Modulating (1) with the learnt features of
...
interventions~\footfullcite{greher2010soundscape}. The soundscapes that I will create
...
challenge in social robotics~\footfullcite{hoffman2019anki}, the WP suggests a very novel
...
intentionality~\footfullcite{wiese2017robots}, while maintaining human oversight.
...
systems~\footfullcite{oudeyer2005playground,forestier2017unified}). This task designs
...
learning~\footfullcite{senft2017supervised,senft2019teaching,winkle2020insitu}, this task
...
architecture~\footfullcite{lemaignan2017artificial}, this task brings together, in a
...
experience transfer~\footfullcite{madden2004transfer} that enables the re-assessment of
...
approach~\footfullcite{winkle2018social} to design the role of the robot with the
...
\subsection{Contribution to key societal and economic challenges}

As stated in the introduction, this research will result in \textbf{a robot that (1) has an
effective social utility, and (2) will see long-term acceptance by its
end-users}. \textbf{From healthcare to manufacturing
4.0, this result will have a major impact on our digital future, far beyond the
boundaries of the project}.

\TODO{explain why}

\subsection{Establishing a unique world leading position in intelligent social
robotics}

As a ground-breaking project, \project will assert and reinforce the UK
leadership in AI and intelligent robotics, in line with the UK's strong societal
...
responsible digital future in the United Kingdom and in Europe}. 


\subsection{Relation and complementarity with the EPSRC portfolio}
...
\project work plan. Beyond strong leadership, the breadth and depth of my
interdisciplinary expertise in Human-Robot Interaction is academically
recognised, as illustrated in Table~\ref{pi-expertise}.

I am also a technology expert, with major software and hardware contributions to the robotic community. As such,
I have a clear grasp of the technical feasibility of the proposed work. I am
also in the rare position of having substantial experience in designing and
running full architectures for complex autonomous social
robots\footfullcite{lemaignan2017artificial}\footfullcite{winkle2020insitu}.
...
\begin{table}[h]
    ...
    \begin{tabular}{rp{0.6\linewidth}}
        ...
        human factors & \small anthropomorphism~\footfullcite{lemaignan2014dynamics}, cognitive
        correlates~\footfullcite{lemaignan2014cognitive}, social influence~\footfullcite{winkle2019effective} \\
        trust, engagement, social presence & \small \footfullcite{flook2019impact,lemaignan2015youre,fink2014which,irfan2018social} \\
        theory of mind & \small perspective taking~\footfullcite{ros2010which, warnier2012when}, social mutual modelling~\footfullcite{lemaignan2015mutual,dillenbourg2016symmetry} \\
        \midrule
        \textbf{Social signal processing}\\
        non-verbal behaviours & \small attention~\footfullcite{lemaignan2016realtime},
        child-child dataset~\footfullcite{lemaignan2018pinsoro}, internal state decoding~\footfullcite{bartlett2019what} \\
        verbal interactions & \small speech recognition~\footfullcite{kennedy2017child}, dialogue grounding~\footfullcite{lemaignan2011grounding} \\
        \midrule
        \textbf{Behaviour generation} \\
        social behaviours & \small \footfullcite{lallee2011towards}, verbal interactions~\footfullcite{wallbridge2019generating, wallbridge2019towards}, physical interactions~\footfullcite{gharbi2013natural} \\
        interactive reinforcement learning & \small \footfullcite{senft2017leveraging,senft2017supervised, senft2019teaching} \\
        \midrule
        \textbf{Socio-cognitive architectures} \\
        architecture design & \small \footfullcite{lemaignan2017artificial, baxter2016cognitive,lemaignan2014challenges,lallee2012towards, mallet2010genom3} \\
        knowledge representation & \small
        ontologies~\footfullcite{lemaignan2010oro, lemaignan2013explicit} \\    
        spatio-temporal modelling & \small object
        detection~\footfullcite{wallbridge2017qualitative}, physics-aware situation
        assessment~\footfullcite{lemaignan2018underworlds,sallami2019simulation} \\
        \midrule
        \textbf{Fieldwork in HRI} & \small in
        classrooms~\footfullcite{hood2015when, lemaignan2016learning, jacq2016building,
        baxter2015wider,kennedy2016cautious,senft2018robots}, at home~\footfullcite{mondada2015ranger}\\
        %\midrule
        %Robot hardware design for interaction & \small \footfullcite{ozgur2017cellulo, hostettler2016realtime} \\
        \bottomrule
    \end{tabular}
    \label{pi-expertise}
\end{table}
...
%economy~\footfullcite{williams2020social}. A recent report from the United Nations about
...
%some job categories and creating others~\footfullcite{bruckner2017frontier}. Social
...
%development, and autonomous vehicles to name a few~\footfullcite{baillie2019challenges}.
...
%mature~\footfullcite{tulli2019great}.
%
%Indeed, understanding \emph{why} these robots have failed, is one of the
%active debate within the Human-Robot Interaction
%community~\footfullcite{hoffman2019anki}, with only a handful of qualitative studies on
%this question~\footfullcite{dereshev2019longterm,degraaf2017phased}. Proposed
...
%repetitive~\footfullcite{lemaignan2014cognitive}; the poor management of expectations,
...
%social engagement~\footfullcite{yang2018grand,hoffman2019anki}
%
...
%of research in robotics for education, Belpaeme et al.~\footfullcite{belpaeme2018social}
...
%common~\footfullcite{kunze2018artificial,leite2013social}, with a number of studies
%involving social robots deployed in real-world settings (for instance in
%schools~\footfullcite{leite2014empathic,westlund2017measuring,
%lemaignan2016learning,coninx2016towards}, homes~\footfullcite{degraaf2017phased} and
%care centres~\footfullcite{hawes2017strands,winkle2020insitu}) over relatively long
...
%butler-like robot answering simple questions, like in~\footfullcite{hawes2017strands} or
%in the H2020 MuMMer~\footfullcite{heikkila2018can} and FP7
%Spencer~\footfullcite{triebel2016spencer} projects), or a narrow, well-specified complex
%task (for instance, supporting exercising in a gym, as I did in~\footfullcite{winkle2020insitu}).
...
%DREAM projects: in Aliz-e, \footfullcite{baxter2011long,coninx2016towards} report on how
...
%instance review by Pennisi et al.~\footfullcite{pennisi2016autism}). This specific
...
%processing of emotions. See my review in~\footfullcite{lemaignan2015mutual}). This
%research draws on the extensive prior research in experimental cognitive
%sciences on autism (for instance~\footfullcite{baron1985does, frith1994autism}), and the
...
%%(up to 2 or 3 months at a time)~\footfullcite{kunze2018artificial,leite2013social}. Even
%%though these robots are rarely fully autonomous, they do already show high
%%levels of autonomy~\footfullcite{senft2019teaching}, with full autonomy in
%%sight~\footfullcite{hawes2017strands}.
%%
...
%%society, only exists in fragmented, disconnected pieces~\footfullcite{citeneeded}.
%%
%%
...
%%past~\footfullcite{wrede2012towards}, but only effectively realised for relatively
%%simple cognitive systems (like curiosity-driven robot
%%animals~\footfullcite{oudeyer2005playground} or motor babbling in infant-like
%%robots~\footfullcite{forestier2017unified}). However, socially-driven robots,
...
%for~\footfullcite{senft2019teaching} and~\footfullcite{winkle2020insitu}), and interviews of both the
...
%cognitive architectures~\footfullcite{lemaignan2017artificial,beetz2010cram}. This task
%builds on existing work on symbolic knowledge representation
%(eg~\footfullcite{tenorth2009knowrob} or my own work~\footfullcite{lemaignan2010oro}) and my
%work on situation assessment~\footfullcite{lemaignan2018underworlds} (that includes for
%instance object recognition and physics
%simulation~\footfullcite{sallami2019simulation}), to create a coherent system of
%representations for the cognitive architecture that extends the \sc{underworlds}
%spatio-temporal representation tool~\footfullcite{lemaignan2018underworlds} with
%symbolic and hybrid (like \emph{conceptors}~\footfullcite{jaeger2014controlling})
...
%signals~\footfullcite{gunes2017automatic} to build a multi-modal model of the humans
%in the robot's vicinity. I have recently introduced a dataset of social
%interaction~\footfullcite{lemaignan2018pinsoro} that enables for the first time a
...
%interactions~\footfullcite{bartlett2019what}. This dataset and the related methodologies
...
%$f$-formations~\footfullcite{marshall2011using}, sociograms (as done
%in~\footfullcite{garcia2016hybrid} for instance), and inter-personal
%affordances~\footfullcite{pandey2013affordance}. This task builds on literature on on
%social dynamics analysis (eg~\footfullcite{durantin2017social,jermann2009physical,
%martinez2019collocated}) to apply it to real-time social assessment by a robot,
%itself embedded into the interaction.
%
...
%perspective taking~\footfullcite{flavell1992perspectives} (as I previously framed
%in~\footfullcite{lemaignan2015mutual, dillenbourg2016symmetry}).
%
...
%Happé~\footfullcite{frith1994autism} to investigate theory of mind with autistic
%children, as it offers an excellent experimental framework for social
%robotics~\footfullcite{lemaignan2015mutual} for this work.
%
...
%%for her marble?'' in Baron-Cohen's protocol~\footfullcite{baron1985does}) and eventually
...
%%        \midrule
%%        Ordering behavioural pictures     & Ordering mentalistic pictures~\footfullcite{baron1986mechanical} \\
%%        Understanding see                 & Understanding know~\footfullcite{perner1989exploration}            \\
%%        Protoimperative pointing          & Protodeclarative pointing~\footfullcite{baron1989perceptual}     \\
%%        Sabotage                          & Deception~\footfullcite{sodian1992deception}                     \\
%%        False photographs                 & False beliefs~\footfullcite{leslie1992domain}                 \\
%%        Recognizing happiness and sadness & Recognizing surprise~\footfullcite{baron1993children}          \\
%%        Object occlusion                  & Information occlusion~\footfullcite{baron1992out}         \\
%%        Literal expression                & Metaphorical expression~\footfullcite{happe1993communicative}       \\
%%        \bottomrule
%%    \end{tabular}
%%    \caption{\small Tasks requiring or not mentalizing to pass, listed by Frith and Happé in~\footfullcite{frith1994autism}}
...
%%protocol originally proposed by Oswald and Ollendick~\footfullcite{oswald1989role} and
%%replicated and extended by Baron-Cohen in~\footfullcite{baron1992out}, who describes it
...
%techniques like curiosity-driven behaviours~\footfullcite{oudeyer2005playground},
%Learning from Demonstration~\footfullcite{billard2008robot, argall2009survey},
%human-in-the-loop action policy learning~\footfullcite{senft2016sparc,
...
%
%Using activity switching to support long term engagement with diabetic children~\footfullcite{coninx2016towards}
%
%\begin{framed}
...
%generation~\footfullcite{marmpena2019generating,suguitan2020moveae}; (2) interactive
...
%behaviours~\footfullcite{senft2019teaching, winkle2020insitu} that fully involve the
%end-users~\footfullcite{winkle2018social}.
%
%In~\footfullcite{suguitan2020moveae}, a Generative Adversarial Network (GAN) is trained
...
%%fades~\footfullcite{lemaignan2014dynamics}, leading to critical user disengagement from the technology.
%%
%%
...
%%        engagement, as proposed by Hoffman~\footfullcite{hoffman2019anki}
%%\item
...
%(eg~\footfullcite{greher2010soundscape}). The soundscapes that we will create, are
...
%been successfully applied to curiosity-driven robots~\footfullcite{oudeyer2005playground} or motor babbling in infant-like
%robots~\footfullcite{forestier2017unified}, but only for relatively simple cognitive
...
%social learning~\footfullcite{senft2019teaching,winkle2020insitu}, this task
...
%developed with my students in~\footfullcite{senft2017supervised}.
%
...
%ones~\footfullcite{chong2007integrated,vernon2007survey,kingdon2008review,duch2008cognitive,langley2009cognitive,taatgen2010past,thorisson2012cognitive},
%as well as ones specifically developed for robotics:
%ACT-R/E~\footfullcite{trafton2013act}, HAMMER~\footfullcite{demiris2006hierarchical}, PEIS
%Ecology~\footfullcite{saffiotti2005peis,daoutis2012cooperative},
%CRAM/KnowRob~\footfullcite{beetz2010cram, tenorth2009knowrob},
%KeJia~\footfullcite{chen2010developing}, POETICON++~\footfullcite{antunes2016from}, and my own,
%the LAAS Architecture for Social Interaction~\footfullcite{lemaignan2017artificial}):
...
%learning for experience transfer~\footfullcite{madden2004transfer} that enables the
...
%autonomy~\footfullcite{senft2017supervised}, and \emph{without} requiring the
...
%schools~\footfullcite{robot4sen}, the first study investigate whether a socially
...
%Patient and Public Involvement methodologies (PPI~\footfullcite{boivin2010patient}),
...
%Interviews~\footfullcite{westlund2017measuring}), to understand how the robot impacts
...
%        the system (like an ethical \emph{black-box}~\footfullcite{winfield2017case})?
...
%Intelligence~\footfullcite{eu2019ethics} is a strong sign of this commitment. These
...
%principles of responsible design are somewhat established~\footfullcite{stahl2016ethics,
...
%sensitive, informations~\footfullcite{martelaro2016tell,shiomi2017robot}.  As an
%example, a common objection to human-robot interaction is the perceived
%deceptive nature of the robot's role. It has been
%argued~\footfullcite{biscontilucidi2018companion} that the underlying concern is likely
...
%humankind.''~\footfullcite{allen2011robot}. Specific subfields, like assistive
%robotics~\footfullcite{sharkey2012granny}, have seen some additional work, but social
...
%children~\footfullcite{lemaignan2016learning,lemaignan2018pinsoro,senft2019teaching}),
...
%in~\footfullcite{stilgoe2013developing} (and has been subsequently adopted by the UK Engineering
%and Physical Sciences Research Council~\footfullcite{owen2014uk}) using the acronym
...
%framework~\footfullcite{stahl2018implementing}~\footnote{\url{https://www.orbit-rri.org/about/area-4p-framework/}},
...
%PI
%expertise~\footfullcite{lemaignan2018underworlds,sallami2019simulation,lemaignan2010oro}.
...
%datasets~\footfullcite{lemaignan2018pinsoro,sallami2020unexpected}, and does not
...
%environments~\footfullcite{senft2019teaching,winkle2020insitu}. While they will require
...
%PI~\footfullcite{lemaignan2017artificial}. This task however includes significant novel
...
%PI has previously contributed~\footfullcite{lemaignan2017artificial}. By doing so, a
