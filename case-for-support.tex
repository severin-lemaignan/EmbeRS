...
My aim is to create, sustain and better
understand the dynamics of responsible long-term social human-robot
interactions, in order to build a robot that (1) has an
...
\subsection{Methodology and approach to achieve impact}

This aim is underpinned by two principles that form the scientific backbone of
the project: for end-users to ascribe social utility and engage with the robot
over long periods of time (months, years), the robot has to have its own
long-term internal motivation to be socially helpful -- what we call a
\emph{social teleology}; additionally, long-term acceptance requires the genuine
involvement of end-users at every step of the design process, so that they take
\emph{ownership} of the technology -- human-in-the-loop machine learning offers
a promissing way forward, by permitting to design robot behaviours that
genuinely originate from the end-users themselves.
...
interactions at the societal level. I will co-construct this framework through large scale public
...
modeling (so-called \emph{situation assessment}) with recent research in social
state modeling. This objective addresses one part of RQ2, and is investigated in
WP2.
...
environments~\footfullcite{senft2017supervised, senft2019teaching, winkle2020couch} -- relies
...
behaviours~\footfullcite{senft2019teaching, winkle2020couch} that fully involve the
...
learning~\footfullcite{senft2017supervised,senft2019teaching,winkle2020couch}, this task
...
%care centres~\footfullcite{hawes2017strands,winkle2020couch}) over relatively long
...
%task (for instance, supporting exercising in a gym, as I did in~\footfullcite{winkle2020couch}).
...
%for~\footfullcite{senft2019teaching} and~\footfullcite{winkle2020couch}), and interviews of both the
...
%social learning~\footfullcite{senft2019teaching,winkle2020couch}, this task
...
%environments~\footfullcite{senft2019teaching,winkle2020couch}. While they will require
