...
\newcommand{\wpFour}{Downstream tasks: engagement and behaviour generation}
\newcommand{\wpFourShort}{Engagement and behaviour generation}


\newcommand{\wpFive}{Interactive Machine Learning for lifelong learning}
\newcommand{\wpFiveShort}{Interactive machine learning}


\newcommand{\wpSix}{Social Embeddings and Responsible Robotics}
