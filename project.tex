...
\noindent\framebox[\linewidth]{Duration: \textbf{Y1-Y3}; one senior post-doc in sociology of technology}
...
\noindent\framebox[\linewidth]{Duration: \textbf{Y1-Y5}; one post-doc in social signal processing/machine
learning/cognitive modelling}
...
\noindent\framebox[\linewidth]{Duration: \textbf{Y1-Y5}; one senior post-doc in cognitive robotics; one PhD
student}
...
\noindent\framebox[\linewidth]{Duration: \textbf{Y3-Y5}; one post-doc in HRI/machine learning/learning from
demonstration}
...
\noindent\framebox[\linewidth]{Duration: \textbf{Y2-Y5}}
