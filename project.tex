...
\textbf{T1.1 -- Conceptual framing and crowd-sourced interaction principles}

The first task in WP1 is to research and
...
\textbf{T5.1 -- Ethical framework}
This first task is a pre-requisite for each of the field experiments (T1.1,
T5.2. T5.3), and will cover the whole duration of the project. This work is
...
Education Need (SEN) school (T5.2), followed by a one-year deployment at
Bristol's Children hospital (T5.3). These two additional experiments are both
...
datasets acquired during the field deployments (T1.1, T5.2, T5.3), as well as
...
researching and developing the socio-cognitive drive of the architecture. They
come both from T1.2 (as previously mentioned), and
human-in-the-loop/public-in-the-loop machine learning (T3.2). This task is also
tighly connected to the experimental fieldwork.
...
\textbf{Together, Task 5.2 and 5.3 are \ul{high-risk, high-gain}.}
