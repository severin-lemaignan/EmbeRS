...
The technical work programme of \project is shared between Workpackages WP2, WP3
and WP4. Figure~\ref{fig:archi} gives an overview of the software architecture
that I will develop for the robots.

\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{figs/archi}
\caption{Overview of the technical components of the robot.}
\label{fig:archi}
\end{figure}
