...
attention, expressive motions. In WP3, my team will work with a choreographer
and a sound expert to create a new grammar of expressive motions, combined with
a novel modality based on \emph{soundscapes}: sound landscapes that the robot
...
The aim of the \project project is to \textbf{engage and sustain long-term
social human-robot interactions in a responsible way}.

Three broad research questions follow from this high-level aim:

\paragraph{\bf RQ1:} what are the public expectations with respect to the role of social
        robots? can we agree upon principles ensuring safe, beneficial, socially
        acceptable robots? 
...
robot, and formalise them in guidelines.

\paragraph{\bf O2: social modeling}: I will significantly extend and integrate
...
the robot to represent in real-time the social dynamics of its environment.


\paragraph{\bf O3: cogruent social behaviours production}: using the
state-of-the-art in generative neural networks with data acquired from an expert
choreographer, I will create a novel way of producing non-repetitive,
socially-congruent, expressive motions. 

\paragraph{\bf O4} [embodied AI breakthrough]: I will how will these principles
...
\paragraph{\bf O5} [experimental level]: can we demonstrate in complex, real
...
The cost for the WP4 PhD student (PHD1) has not been included, as the host
