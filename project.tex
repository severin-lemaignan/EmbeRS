...
\usepackage[style=verbose-note, maxbibnames=19,maxcitenames=2,firstinits=true,sorting=none]{biblatex}

\usepackage{footmisc}

% avoid repeating footnote refernece
% from: https://tex.stackexchange.com/questions/200286/biblatex-repeated-citations-in-footnotes-that-point-back-to-earlier-footnotes
\makeatletter
