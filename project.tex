...
interactions} The conceptual framework identified in T1.1 is translated into a
...
These part of the work is the technical core of the project: I will create a
...
trustworthy action policies. This part is high-risk/high-gain, as no such
combined approach has been attempted before in real-world, complex social
situations. I will mitigate the risk by ensuring cognitive functions are
decoupled from each other where sensible, and in particular, ensure that action
policies can be generated independently through intrinsic motivation or
human-taught social policies, hence creating a level of cognitive redundancy.
...
architecture. It builds from the principles identified in T1.2, and relies on a
...
additional outcome of this design stage is a set of cognitive requirements that
will inform WP3 and WP4.
...
social learning~\cite{senft2019teaching}, this task implements the learning
mechanics (including the critical aspect of the interface with the human
teacher) to allow human participants to progressivly teach the robot a social
policy to become a good social helper. This task also research whether and how
human-in-the-loop machine learning, by involving the end-users in the creation
of the robot behaviours, enables a more trustworthy AI system.
...
This WP will result in the formulation of a socio-cognitive model of the
...
\textbf{T3.3 -- Social situation assessment} knowledge representation and
...
state-of-art (eg~\cite{sallami2019simulation}) and extend it to include the
representation of the social situation. This entails hybrid
symbolic/sub-symbolic representations.
...
\hspace*{-0.5cm}\begin{tabular}{p{1.7cm}p{7cm}p{8cm}}
    ...
    robotics.\textbf{[lead researcher]}\\
   ...
   \newline\href{https://doi.org/10.1109/IROS.2018.8594094}{\textbf{{\sc
    ...
    \textbf{\newline[lead researcher; 99 citations]}\\
    ...
    \textbf{\newline[lead researcher; 154 citations]}\\
