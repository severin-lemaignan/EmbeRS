...
\newcommand{\WPA}{Social Embeddings construction and characterising}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\WPB}{Social awareness}
\newcommand{\wpB}{Social awareness}

\def\tBA{T2.1}
\newcommand{\TBA}{{\bf \tBA} -- Social appraisal and context}
\def\tBB{T2.2}
\newcommand{\TBB}{{\bf \tBB} -- Social learning}
\def\tBC{T2.3}
\newcommand{\TBC}{{\bf \tBC} -- Social dynamics and predictions}
...
\def\tCA{T3.1}
\newcommand{\TCA}{{\bf \tCA} -- Integration of perception routines to generate
social descriptions}
\def\tCB{T3.2}
\newcommand{\TCB}{{\bf \tCB} -- Socially-aware supervisor}
\def\tCC{T3.3}
\newcommand{\TCC}{{\bf \tCC} -- Integration of the complete cognitive architecture}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\WPD}{Empirical study of social embeddings}
\newcommand{\wpD}{Experimental research}

\def\tDA{T4.1}
\newcommand{\TDA}{{\bf \tDA} -- Demonstrating social awareness}
\def\tDB{T4.2}
\newcommand{\TDB}{{\bf \tDB} -- Social embeddings for mentalizing tasks}
\def\tDD{T4.3}
\newcommand{\TDD}{{\bf \tDD} -- Social embeddigns to facilitate social learning}
\def\tDC{T4.4}
\newcommand{\TDC}{{\bf \tDC} -- Social embeddings as enabler of social autonomy}
