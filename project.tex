...
assessment (eg~\cite{sallami2019simulation}) and creates a coherent system of
representations for the cognitive architecture. This will rely on hybrid AI
techniques, including established symbolic modelling (ontologies and first-order
logic~\cite{lemaignan2010oro, tenorth2009knowrob}), as well as hybrid
symbolic/sub-symbolic modelling (using Jaeger's
conceptors~\cite{jaeger2014controlling}).

\textbf{T2.2 -- Social dynamics}

\TODO{}

\textbf{T2.3 -- Interaction dynamics}
