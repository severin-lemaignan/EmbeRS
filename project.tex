...
Firstly, the basic ambition of \project is to create a conceptual framework
around social robots in the human society, by reframing the widely accepted, yet
...
support stronger, positive interactions between humans. This framework will
create the (currently missing) conceptual frame around questions like: what role
...
interactive machine learning, where the robot learns from and with the
end-users, while interacting with them.
