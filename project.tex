...
Instead of having the robot at the centre of the stage, the humans are: we build from
...
long-term benefits to the society. This requires strong leadership to genuinely
and meaningfully involve of the public at large; and scientific, technical and
methodological excellence to realise this vision. \textbf{\project aims at
...
means that it has no clear stopping point. \project offers an
...
\begin{itemize}
    \item \textbf{R1} [conceptual framing]: how the abstract idea of
        ...
        (implementable) interaction design principles? What should motivate the
        robot to step in and attempt to help? What are the determinants
...
task will embed \project into the 'City lab' experiment, led by WeTheCurious,
Bristol's science museum. WeTheCurious is leading the push for a new form of
...
public. For an initial period of one year (during Y2), one \project robot will be
...
\subsection{Overview budget}

\TODO{FOR INFORMATION ONLY -- FINAL BUDGET TO BE DIRECTLY INPUT ON ERC
WEBSITE}
\vspace{1cm}
...
\textbf{Staff}                                                    &             &             &             &             &             \\ \midrule
                                                                  &             &             &             &             &             \\
                                                                  & \textbf{Y1} & \textbf{Y2} & \textbf{Y3} & \textbf{Y4} & \textbf{Y5} \\ \midrule
\textbf{Directly allocated}                                       &             &             &             &             &             \\
Séverin Lemaignan                                                 & 0.6         & 0.6         & 0.6         & 0.6         & 0.6         \\ \midrule
\textbf{Directly incurred}                                        &             &             &             &             &             \\
SRF 1 (sociology/anthropology, WP1)                               & 1           & 1           & 1           &             &             \\
RF 2 (social signal processing/machine learning, WP2)             & 1           & 1           & 1           & 1           & 1           \\
SRF 2 (cognitive architecture for robotics, experiments, WP3 WP5) & 1           & 1           & 1           & 1           & 1           \\
PhD 1 (social signal processing/machine learning, WP3 WP5)        &             & 1           & 1           & 1           &             \\
RF2 (behaviour generation, WP4)                                   &             &             & 1           & 1           & 1           \\
                                                                  &             &             &             &             &             \\
\multicolumn{1}{r}{\textbf{total DI}}                             & 3           & 3           & 3           & 2           & 2           \\ \midrule
                                                                  &             &             &             &             &             \\
\textbf{Other costs}                                              &             &             &             &             &             \\
\textbf{}                                                         & unit price  & quantity    &             & total       &             \\ \midrule
                                                                  &             &             &             &             &             \\
R1 robot (ex VAT)                                                 & 122000      & 2           &             & 244000      &             \\
R1 shipping                                                       & 3500        & 2           &             & 7000        &             \\
R1 installation and training                                      & 3800        & 1           &             & 3800        &             \\
                                                                  &             &             &             &             &             \\
Open access fees (2 articles/y)                                   & 1200        & 10          &             & 12000       &             \\
Conferences (1 per person per year) + travel                      & 2300        & 30          &             & 69000       &             \\
                                                                  &             &             &             &             &             \\
Participants compensations                                        & 3000        & 1           &             & 3000        &             \\
                                                                  &             &             &             &             &             \\
Workstation suitable for machine learning                         & 4000        & 5           &             & 20000       &             \\
Sensors (incl RGB-D cameras, one eye tracker)                     & 7000        & 1           &             & 7000        &             \\
Data storage                                                      & 2000        & 1           &             & 2000        &             \\
Cloud computing (incl crowd sourcing)                             & 5000        & 1           &             & 5000        &             \\
                                                                  &             &             &             & 0           &             \\
                                                                  &             &             &             &             &             \\
Other consumables                                                 & 10000       & 1           &             & 10000       &             \\ \bottomrule
\end{tabular}
...
\begin{itemize}
    \item R1 robot: acceptable to hospital thanks its plastic shell that can be
        easily cleaned-up
\end{itemize}
