...
\begin{framed}
    {\noindent\bf Main outcomes of T1.1:}
\end{framed}
...
\begin{framed}
    {\noindent\bf Main outcomes of T1.2:}
\end{framed}
...
\begin{framed}
    {\noindent\bf Main outcomes of T2.2:} A data-driven social signal processing
    pipeline to model the surrounding humans and its integration into the
    representation system of T2.1.
\end{framed}
...
\begin{framed}
    {\noindent\bf Main outcomes of T2.3:}
\end{framed}
...
\begin{framed}
    ...
    past events (temporal model) and queries requiring perspective taking.
\end{framed}
...
\textbf{T3.2: Machine learning for continuous motion generation}
\project aims
...
learning in high-dimensional input/output spaces~\cite{senft2019teaching}, where I
...
\begin{framed}
    {\noindent\bf Main outcomes of T3.3:}
\end{framed}
...
\begin{framed}
    {\noindent\bf Main outcomes of T4.1:}
\end{framed}
...
\begin{framed}
    {\noindent\bf Main outcomes of T4.2:}
\end{framed}
...
The first one involves the deployment of social robots in special need schools
