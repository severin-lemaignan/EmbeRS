...
end of the fellowship, I will have moved from being a regional leader in HRI, to
having established myself as a world-leader in the emerging field of
socially-driven, responsible autonomous robots, significantly reinforcing the European
capacity in this critical field for our digital future.
...
recognised centre in robotics for eduction. While my original training was in
...
others~\cite{bruckner2017frontier}. Social robotics, however, is still an
young, emerging, research-active field. The expectations are high, in multiple
application domains: elderly
care, customer service (in airports and shopping malls, for instance), education, child development,
and autonomous vehicles to name a few~\cite{baillie2019challenges}. However,
whereas both computer-based AI applications, and traditional industrial robots
already have a significant economic impact, social robots have not reached that
point yet. Significantly, the recent failures of several companies investing in
social robotics, like Jibo, Kuri, Willow Garage and Anki, and the major setbacks
of companies like SoftBank, who designed and deployed hundreds of Pepper robot in their
shops, before giving up a few months later due to the poor reception by the
customers, show that these technologies are not yet mature~\cite{tulli2019great}.
...
community~\cite{hoffman2019anki}. Proposed explanations include the lack of
perceived usefulness (robot seen purely as a toy); the limited liveliness of the robot that become rapidly
predictable and repetitive~\cite{lemaignan2014cognitive}; the poor management of
expectations, where user over-ascribe cognitive capabilities that do not match
the reality. The community agrees however that the crux of the issue is
achieving long-term social engagement~\cite{leite2013social,hoffman2019anki}

Studies of long-term human-robot interaction studies are becoming more
common~\cite{kunze2018artificial,leite2013social}, with a number of studies
involving social robots deployed in real-world settings (for instance
schools~\cite{leite2014empathic,westlund2017measuring,
lemaignan2016learning,coninx2016towards} and care
centres~\cite{hawes2017strands,winkle2020couch}) over relatively long periods of
time (up to 2 or 3 months at a time). Even though these robots are rarely fully
autonomous, they do already show high levels of
autonomy~\cite{senft2019teaching,winkle2020couch,hawes2017strands} for either a
broad range of shallow tasks (eg, a butler-like robot, like
in~\cite{hawes2017strands}), or a narrow, well-specified complex task (for
instance, supporting exercising in a gym~\cite{winkle2020couch}).

Research is however seemingly hitting a wall to further progress towards
socially meaningful long-term interactions. In their large review of
research in robotics for education, Belpaeme et al.~\cite{belpaeme2018social}
point to the shortcomings that prevent further development of social
robots in educative settings: the need for a correct interpretation of the
social environment; the difficulty of action selection; the difficulty of pacing
...
Object {\bf O4'}: The design of a policy arbitration mechanism that preserve
...
expressive communication; the WeTheCurious museum will provide training in
...
Neighbouring societal applications

As the ability to discover and react to errors is fundamental to any HRI system,
\project results will have a major impact on any societal area in which robots
will be used to support and collaborate with humans in  the future. Error
handling is especially important in assisted living. Robots will be used in the
future to support older adults to be able to stay longer in their homes with an
increased quality of life and to reduce the economic burden that the ageing
society will have on the economies of developed countries. BRL has a test bed
for assisted living that is approved for challenges in the European Robotics
League
(ERL)\footnote{\url{http://www.brl.ac.uk/research/researchthemes/assistedliving/assistedlivingstudio.aspx}}.
In order to prove that the \project results are valuable for the assisted living
use case, we will work together with Dr Praminda Caleb-Solly from BRL, who is
heading a team that takes part in the ERL competition. E.g., the ERL challenge
subtask ``TBM2: Welcoming
Visitors''\footnote{\url{https://sites.google.com/site/erlsrbrl2017/competition}}
could become more robust by applying the \project error recognition and response
generation strategies. BRL will embed one of the ERRO post docs in the ERL team
to test the \project technology in the competition's challenges. This will not
only increase the project's visibility but also the robustness and
generalisability of the error recognition and response approaches.

Scientific dissemination

Project partners will publish scientific results in high-class scientific
journals and conferences. Table \ref{tab:conf-journ} lists the targeted journals
and conferences for each related research area. For a more targeted scientific
dissemination, the partners will organise one \project-themed workshop each project
year. In the first year, the partners will present the project results as part
of the already established PubRob workshop
series\footnote{\url{http://www.pubrob.org}}, a long-standing workshop series on
Public Space Human-Robot Interaction, organised by Manuel Giuliani (BRL), Ron
Petrick (HWU), and Mary Ellen Foster from the University of Glasgow. In the
second and third year, workshops will be organised at a human factors oriented
conference (e.g.~HRI) and a robotics-oriented conference (e.g.~IROS or ICRA),
respectively.

\begin{table}[t]
    \scriptsize
	\caption{Targeted conferences and journals sorted by research area}
	\begin{tabular}{@{}p{25mm}p{55mm}p{81.5mm}@{}}
		\toprule
		\textbf{Research area}  & \textbf{Conferences}  & \textbf{Journals} \\ \midrule
		HRI & HRI, HAI, IEEE Ro-Man & IEEE Trans.~on HRI, IEEE Trans.~on Human-Machine Systems \\
		Robotics                & ICRA, IROS, RSS       & Science Robotics, IEEE Trans.~on Robotics, Frontiers in Robotics and AI \\
		Computer Vision          & CVPR, ECCV, ICCV, NIPS, BMVC      & IEEE Trans.~on Pattern Analysis and Machine Intelligence, Int.~Journ.~of Computer Vision, Pattern Recognition, Computer Vision and Image Understanding                                                                                 \\
		Automated Planning           & ICAPS, AAAI, IJCAI, KR                      & Journ.~of Artificial Intelligence Research, Artificial Intelligence Journ.~, Computational Intelligence                                                                                \\
		Cognitive Psychology    & Applied Human Factors and Ergonomics, Human Factors and Ergonomics Society & Journ.~of Experimental Psychology, Human Factors, Computers in Human Behaviour, Int.~Journ.~of Human Computer Studies \\
		%Nat.~Lang.~Processing & ACL, Interspeech & \\ 
		\bottomrule
	\end{tabular}
	\label{tab:conf-journ}
\end{table}
...
integrate the robot in the Bristol Science museum WeTheCurious.
...
The Bristol science museum will provide in-kind training in science
communication, as well as in-kind access to the museum facilities, for the
duration of museum study. The training (10 days in total) would have normally
been billed £3,000 by the museum.
\markdownoff
