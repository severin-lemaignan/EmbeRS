...
\def\tCB{T3.2}
\newcommand{\TCB}{{\bf \tCB} -- Integration of the agent's actions}
\def\tCC{T3.3}
...
\def\tDB{T4.2}
\newcommand{\TDB}{{\bf \tDB} -- Characterizing social situation awareness}
\def\tDC{T4.3}
\newcommand{\TDC}{{\bf \tDC} -- Social situation awareness in a virtual world}
\def\tDD{T4.4}
